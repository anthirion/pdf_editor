...
class TestPDFToJPGConversion(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.jpg_files = list(self.test_output_folder.glob("*.jpg"))

    def tearDown(self) -> None:
        # Nettoyage après les tests
        for item in self.jpg_files:
            item.unlink()
    ...
    def test_non_existing_pdf_conversion(self) -> None:
        ...
        self.assertEqual(len(self.jpg_files), 0)
